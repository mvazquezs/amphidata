...
cuts_arena <- seq(
  from = min(df_g[['superficie_arena']], na.rm = TRUE),
  to = max(df_g[['superficie_arena']], na.rm = TRUE),
  length.out = 19)

cuts_general <- seq(
  from = min(df_g[['superficie_general']], na.rm = TRUE),
  to = max(df_g[['superficie_general']], na.rm = TRUE),
  length.out = 19)

cuts_aforament <- seq(
  from = min(df_g[['nombre_places']], na.rm = TRUE),
  to = max(df_g[['nombre_places']], na.rm = TRUE),
  length.out = 19)
